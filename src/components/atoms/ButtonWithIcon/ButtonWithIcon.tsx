...
export const button = tv(
    {
        ...
        variants: {
          color: {
            primary: '  bg-primary rounded-none py-3 px-10  border-0 font-inter flex flex-row gap-2 items-center  justify-center ',
            secondary: ' bg-secondary rounded-none py-3 px-10  border-0 font-inter flex flex-row gap-2 items-center justify-center',
            dark: 'bg-dark py-3 px-10  border-0  flex flex-row gap-2  font-inter items-center justify-center'
          },
          size: {
